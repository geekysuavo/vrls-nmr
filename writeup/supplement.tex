...
\\
\rho_c &\sim
 \delta_\rho^{-1} \sum_{r=1}^{\delta_\rho} Z_r^2,
 \quad\text{where } Z_r \sim \mathcal{N}(0, 1)
\\
\alpha_c &\sim
 \delta_\alpha^{-1} \sum_{r=1}^{\delta_\alpha} Z_r^2,
 \quad\text{where } Z_r \sim \mathcal{N}(0, 1)
\\
...
% ==================================================================s===========
\clearpage
\subsection{Reconstruction errors by schedule}
The following figures compare VRLS reconstruction errors to IST-S and FMF-VRLS
reconstruction errors for various selections of schedules. Positive values
indicate that VRLS has lower error.
...
\caption{%
 Matched-schedule relative errors, VRLS rel.~IST-S.
}
\end{figure*}
...
\caption{%
 Matched-schedule relative errors, VRLS rel.~FMF-VRLS.
}
\end{figure*}
...
% =============================================================================
\clearpage
\subsection{Reconstruction errors by algorithm}
The following figures compare reconstruction errors for ANS schedules to
those for other schedules for each reconstruction algorithm. Positive values
indicate that ANS has lower error.
...
\caption{%
 Matched-algorithm relative errors, ANS rel.~Uniform.
}
\end{figure*}
...
\centering
\makebox[\textwidth]{%
\includegraphics[width=1.4\textwidth]{figure-s4.pdf}}
\caption{%
 Matched-algorithm relative errors, ANS rel.~Exponential.
}
\end{figure*}
...
\centering
\makebox[\textwidth]{%
\includegraphics[width=1.4\textwidth]{figure-s5.pdf}}
\caption{%
 Matched-algorithm relative errors, ANS rel.~Poisson-gap.
}
\end{figure*}
...
\centering
\makebox[\textwidth]{%
\includegraphics[width=1.4\textwidth]{figure-s6.pdf}}
\caption{%
 Single schedule and measurement produced by ANS acquisition of the
 signal used to construct Figures 5 and 6 in the manuscript. ANS parameters
 were $m_0=8$, $n_0=32$, $m_{\max}=64$, $n_{\max}=2048$, and
 $\sigma=0.1$ arb.~units.
}
\end{figure*}
