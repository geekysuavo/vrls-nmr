...
sparsity-undersampling phase space \cite{donoho:pnas2009} where successful
reconstructions are expected. To overcome this, ANS begins with an initial
number of measurements $m_0 > 1$ uniformly sampled, and gradually increases
the size of its grid $n$ using a CS-inspired heuristic,
\begin{equation}
n_* = \sup\left\{
  n \le n_{\max}
 \mid
  m/n > \varepsilon \log(1/\varepsilon)
 \right\}
\end{equation}
