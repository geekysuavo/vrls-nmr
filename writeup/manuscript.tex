...
\label{subsec:vrls}
FIXME---Elaborate on all statements made beyond this point.

We employ variational inference \cite{wainwright:ftml2008} to
...
with an initial number of measurements $m_0 > 1$ uniformly sampled
\cite{cullen:mrc2023}, and gradually increases the size of its grid
$n$ using a CS-inspired heuristic,
\begin{equation}
\label{eq:gridsize}
n_* = \sup\left\{
  n \le n_{\max}
