...
The noise $\epsilon$ is drawn from a normal distribution with variance
$\sigma^2 = 1/\tau$.
...
As illustrated by Figure \ref{fig:fixme}, VRLS is a capable NUS
...
VRLS to converge. Figure \ref{fig:fixme} summarizes this effect: for
